<img width="847" height="326" alt="keydip" src="https://github.com/user-attachments/assets/decf7bb2-1a89-4470-8bd4-785da7fe81eb" />

Features:

KeyDip dips bells on the fundamental frequencies of your MIDI inputs.
...
- Parameter smoothing (obviously)
- Default JUCE knobs (ew, no sensitive mousewheel)
...
- Lookahead to make it possible to have an "attack-less" sound
